...
class AnalyseResourceImage:
    ...
    def do_cpuinfo_image(self,name,label,x_list,y_list,min,max,average,target_keywords,target_path):
        try:
            ...
            if target_keywords in label:
                plt.savefig(f'{target_path}/{file_name}')
            plt.close()
        except Exception as e:
            print(f'do_cpuinfo_image is error!!!!!!!!!!!!!!!!!!!!!!! name={name}, label={label}, path={self.path}, file_name={file_name}')
        finally:
            print(f'do_cpuinfo_image path={self.path}, file_name={file_name} is done')

    def do_meminfo_image(self,name,label,x_list,y_list,min,max,average,target_keywords,target_path):
        try:
            file_name = str(name).replace(' ','').replace(':', '').replace('\\', '').replace('/', '')
            ...
            print(
                f'do_meminfo_image is error!!!!!!!!!!!!!!!!!!!!!!! name={name}, label={label}, path={self.path}, file_name={file_name}')
        finally:
            print(f'do_meminfo_image path={self.path}, file_name={file_name} is done')