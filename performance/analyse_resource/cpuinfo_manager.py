...
class CpuinfoManager:
    ...
    def write_to_excel(self,excel_path_name,txt_path_name,analyse_resource_image:AnalyseResourceImage):
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('usr.jpg','usr',self.collection_time_list,list(map(float, usr_highs)),min,max,average)
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('sys.jpg', 'sys', self.collection_time_list, list(map(float, sys_highs)),min,max,average)
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('nic.jpg', 'nic', self.collection_time_list, list(map(float, nic_highs)),min,max,average)
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('idle.jpg', 'idle', self.collection_time_list, list(map(float, idle_highs)),min,max,average)
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('io.jpg', 'io', self.collection_time_list, list(map(float, io_highs)),min,max,average)
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('irq.jpg', 'irq', self.collection_time_list, list(map(float, irq_highs)),min,max,average)
        ...
        # 生成image
        analyse_resource_image.do_cpuinfo_image('sirq.jpg', 'sirq', self.collection_time_list, list(map(float, sirq_highs)),min,max,average)
        ...
        for bean in self.process_cpuinfo_list:
            ...
            for i in range(len(bean.time_list)):
                ...
                x_list.append(value)
            analyse_resource_image.do_cpuinfo_image(f'{process_name}.jpg', process_name, x_list, list(map(float, process_highs)),min,max,average)
